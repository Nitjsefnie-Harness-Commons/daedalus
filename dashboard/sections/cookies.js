...
import { h, clear, truncate, errMsg, toast, armedAction } from './_util.js';
...
export function mount(container) {
  const root = h('div', {},
    ...
    h('div', { class: 'row' },
      h('div', { class: 'grow' }, h('label', {}, 'url'), h('input', { type: 'text', data: { role: 'su' }, placeholder: 'https://example.com/' })),
      h('div', {}, h('label', {}, 'name'), h('input', { type: 'text', data: { role: 'sn' } })),
      h('div', { class: 'grow' }, h('label', {}, 'value'), h('input', { type: 'text', data: { role: 'sv' } })),
      h('div', {}, h('label', {}, 'domain'), h('input', { type: 'text', data: { role: 'sd' } })),
      h('div', {}, h('label', {}, 'path'), h('input', { type: 'text', data: { role: 'sp' }, value: '/' })),
      h('div', {}, h('label', {}, '\u00a0'), h('button', { data: { role: 'set' } }, 'SET')),
    ),
