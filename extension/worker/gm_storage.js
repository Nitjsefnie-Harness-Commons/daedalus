...
// 140x that term.
// `daedalus-segment-origins` is count-capped (SEGMENT_ORIGIN_CAP in
// segment_mint.js) and stays under the ledger's 22 KB term, and only an
// operator adds to it: a page cannot write a `daedalus-` key. Only `gm:`
// keys are summed: the extension's own keys are what the reserve pays for,
// not page budget.
