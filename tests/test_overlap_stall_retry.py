...
def test_silent_stall_recovers_on_second_attempt(tmp):
...
def test_timed_out_drain_declines_the_retry(tmp):
...
def test_second_silent_stall_names_both_attempts(tmp):
