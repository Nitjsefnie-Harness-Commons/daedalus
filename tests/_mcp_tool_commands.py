    ...
    'screenshot': [
        ...
        ({'chrome_tab': 7, 'quality': 60},
         [_ext('_ss', 'screenshot', timeout=15.0, format='png', quality=60,
               tabId=7)]),
        ({'chrome_tab': 7, 'quality': 1},
         [_ext('_ss', 'screenshot', timeout=15.0, format='png', quality=1,
               tabId=7)]),
        ({'chrome_tab': 7, 'quality': 100},
         [_ext('_ss', 'screenshot', timeout=15.0, format='png', quality=100,
               tabId=7)]),
...
TOOL_REFUSALS = {
    ...
    'screenshot': [
        ...
        ({'quality': True}, ValueError, 'quality must be an integer'),
